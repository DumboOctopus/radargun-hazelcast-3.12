 ...
 */
public class Hazelcast4Operations implements BasicOperations, ConditionalOperations {
   protected static final Log log = LogFactory.getLog(HazelcastOperations.class);
   protected static final boolean trace = log.isTraceEnabled();

   protected Hazelcast4Service service = null;

   public Hazelcast4Operations() {
   }

   public Hazelcast4Operations(Hazelcast4Service service) {
