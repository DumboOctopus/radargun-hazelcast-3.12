...
public class Hazelcast4ConfigurationProvider implements ConfigurationProvider {
   protected final Log log = LogFactory.getLog(getClass());
   protected Hazelcast4Service service;

   public Hazelcast4ConfigurationProvider(Hazelcast4Service service) {
