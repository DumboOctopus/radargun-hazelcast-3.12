 ...
 */
public class Hazelcast4ClientOperations implements BasicOperations, ConditionalOperations {
   protected static final Log log = LogFactory.getLog(Hazelcast4ClientOperations.class);
   protected static final boolean trace = log.isTraceEnabled();

   protected Hazelcast4ClientService service = null;

   public Hazelcast4ClientOperations() {
   }

   public Hazelcast4ClientOperations(Hazelcast4ClientService service) {
